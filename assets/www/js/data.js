...
function TryUploadData() {
    ...
    var emailObj = new Email(SendData.title, SendData.date, SendData.images, SendData.captions, SendData.notes, SendData.followupexperience, SendData.evaluation, SendData.type, SendData.Background, SendData.Font, SendData.template, SendData.outcomes, SendData.SelectedFontColour, SendData.principles, SendData.practices);
    ...
    $.ajax({
        ...
        data: {uuid: SendData.uuid, to:SendData.email, body: emailString},
